...
function Container() {
  ...
  return (
    <div className="w-[90%] mx-auto  py-[90px]">
      ...
      <button
        onClick={handleClick}
        className="border-2 border-rich-black-700 font-Montserrat font-semibold text-[1.25rem] leading-[120%] tracking-[-1%] text-rich-black-700 px-8 py-4 rounded-4xl block mx-auto"
      >
        View All Resources
      </button>
    </div>
